function [PQ,PV,nPQ,nPV,P_cal,Q_cal,V_result]= LU_NRpowerflow(S_Base,No_of_Buses,No_of_Lines,Bus_data,Line_data,V_mag_final,V_ang_final,P_load,Q_load,P_gen,Q_gen,Qmax,Qmin,slack,PQ,PV,nPQ,nPV)
