...
% clc; clear all
% close all
function [PQ,nPQ,PV,nPV,Theta,Y_mag,B,G,V_mag,V_Delta,P_gen_cal,Q_gen_cal, V_result,P_load, Q_load]= NR_power_flow(S_Base,No_of_Buses,No_of_Lines,Bus_data,Line_data )
