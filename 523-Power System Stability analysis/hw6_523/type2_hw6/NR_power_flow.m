...
% clc; clear all
% close all
function [PQ,nPQ,PV,nPV,Y_mat,V_mag,V_Delta,P_gen_cal,Q_gen_cal, V_result]= NR_power_flow(S_Base,No_of_Buses,No_of_Lines,Bus_data,Line_data)
...
V_Delta=zeros(No_of_Buses,1); %initial angle
 ...
 tol_max=0.001; % iteration tolerance of the solution
